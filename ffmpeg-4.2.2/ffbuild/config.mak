...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/Users/pro/Desktop/macos_build_ffmpeg_android/ffmpeg-4.2.2/android/x86_64 --libdir=/Users/pro/Desktop/macos_build_ffmpeg_android/ffmpeg-4.2.2/android/libs/x86_64 --arch=x86_64 --cpu=x86-64 --cc=/Users/pro/Library/Android/sdk/ndk/android-ndk-r20b/toolchains/llvm/prebuilt/darwin-x86_64/bin/x86_64-linux-android21-clang --cxx=/Users/pro/Library/Android/sdk/ndk/android-ndk-r20b/toolchains/llvm/prebuilt/darwin-x86_64/bin/x86_64-linux-android21-clang++ --sysroot=/Users/pro/Library/Android/sdk/ndk/android-ndk-r20b/toolchains/llvm/prebuilt/darwin-x86_64/sysroot --extra-cflags='-Os -fpic -march=x86-64' --extra-ldflags= --target-os=android --enable-shared --enable-postproc --enable-gpl --disable-static --enable-jni --disable-symver --disable-asm --enable-cross-compile --disable-gpl --disable-nonfree --enable-runtime-cpudetect --disable-gray --disable-swscale-alpha --disable-programs --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --enable-avdevice --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --enable-swscale --enable-postproc --enable-avfilter --enable-avresample --enable-network --disable-d3d11va --disable-dxva2 --disable-vaapi --disable-vdpau --disable-videotoolbox --disable-encoders --enable-encoder=png --disable-decoders --enable-decoder=aac --enable-decoder=aac_latm --enable-decoder=flv --enable-decoder=h264 --enable-decoder='mp3*' --enable-decoder=vp6f --enable-decoder=flac --enable-decoder=hevc --enable-decoder=vp8 --enable-decoder=vp9 --enable-decoder=h263 --enable-decoder=h263i --enable-decoder=h263p --enable-decoder=mpeg4 --enable-decoder=mjpeg --disable-hwaccels --disable-muxers --enable-muxer=mp4 --disable-demuxers --enable-demuxer=aac --enable-demuxer=concat --enable-demuxer=data --enable-demuxer=flv --enable-demuxer=hls --enable-demuxer=live_flv --enable-demuxer=mov --enable-demuxer=mp3 --enable-demuxer=mpegps --enable-demuxer=mpegts --enable-demuxer=mpegvideo --enable-demuxer=flac --enable-demuxer=hevc --enable-demuxer=webm_dash_manifest --enable-demuxer=mpeg4 --enable-demuxer=rtsp --enable-demuxer=mjpeg --enable-demuxer=avi --disable-parsers --enable-parser=aac --enable-parser=aac_latm --enable-parser=h264 --enable-parser=flac --enable-parser=hevc --enable-parser=mpeg4 --enable-parser=mpeg4video --enable-parser=mpegvideo --enable-bsfs --disable-bsf=chomp --disable-bsf=dca_core --disable-bsf=dump_extradata --disable-bsf=hevc_mp4toannexb --disable-bsf=imx_dump_header --disable-bsf=mjpeg2jpeg --disable-bsf=mjpega_dump_header --disable-bsf=mov2textsub --disable-bsf=mp3_header_decompress --disable-bsf=mpeg4_unpack_bframes --disable-bsf=noise --disable-bsf=remove_extradata --disable-bsf=text2movsub --disable-bsf=vp9_superframe --enable-protocols --enable-protocol=async --disable-protocol=bluray --enable-protocol=concat --enable-protocol=crypto --disable-protocol=ffrtmpcrypt --enable-protocol=ffrtmphttp --disable-protocol=gopher --disable-protocol=icecast --disable-protocol='librtmp*' --disable-protocol=libssh --disable-protocol=md5 --disable-protocol=mmsh --disable-protocol=mmst --disable-protocol='rtmp*' --enable-protocol=rtmp --enable-protocol=rtmpt --enable-protocol=rtp --enable-protocol=sctp --enable-protocol=srtp --disable-protocol=subfile --disable-protocol=unix --disable-devices --disable-filters --disable-iconv --disable-audiotoolbox --disable-videotoolbox --disable-linux-perf --disable-bzlib
prefix=/Users/pro/Desktop/macos_build_ffmpeg_android/ffmpeg-4.2.2/android/x86_64
LIBDIR=$(DESTDIR)/Users/pro/Desktop/macos_build_ffmpeg_android/ffmpeg-4.2.2/android/libs/x86_64
SHLIBDIR=$(DESTDIR)/Users/pro/Desktop/macos_build_ffmpeg_android/ffmpeg-4.2.2/android/libs/x86_64
INCDIR=$(DESTDIR)${prefix}/include
BINDIR=$(DESTDIR)${prefix}/bin
DATADIR=$(DESTDIR)${prefix}/share/ffmpeg
DOCDIR=$(DESTDIR)${prefix}/share/doc/ffmpeg
MANDIR=$(DESTDIR)${prefix}/share/man
PKGCONFIGDIR=$(DESTDIR)/Users/pro/Desktop/macos_build_ffmpeg_android/ffmpeg-4.2.2/android/libs/x86_64/pkgconfig
INSTALL_NAME_DIR=
SRC_PATH=.
SRC_LINK=.
...
INTRINSICS=none
EXTERN_PREFIX=
CC=/Users/pro/Library/Android/sdk/ndk/android-ndk-r20b/toolchains/llvm/prebuilt/darwin-x86_64/bin/x86_64-linux-android21-clang
CXX=/Users/pro/Library/Android/sdk/ndk/android-ndk-r20b/toolchains/llvm/prebuilt/darwin-x86_64/bin/x86_64-linux-android21-clang++
AS=/Users/pro/Library/Android/sdk/ndk/android-ndk-r20b/toolchains/llvm/prebuilt/darwin-x86_64/bin/x86_64-linux-android21-clang
OBJCC=/Users/pro/Library/Android/sdk/ndk/android-ndk-r20b/toolchains/llvm/prebuilt/darwin-x86_64/bin/x86_64-linux-android21-clang
LD=/Users/pro/Library/Android/sdk/ndk/android-ndk-r20b/toolchains/llvm/prebuilt/darwin-x86_64/bin/x86_64-linux-android21-clang
DEPCC=/Users/pro/Library/Android/sdk/ndk/android-ndk-r20b/toolchains/llvm/prebuilt/darwin-x86_64/bin/x86_64-linux-android21-clang
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=/Users/pro/Library/Android/sdk/ndk/android-ndk-r20b/toolchains/llvm/prebuilt/darwin-x86_64/bin/x86_64-linux-android21-clang
DEPASFLAGS= $(CPPFLAGS)
X86ASM=nasm
DEPX86ASM=nasm
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= --sysroot=/Users/pro/Library/Android/sdk/ndk/android-ndk-r20b/toolchains/llvm/prebuilt/darwin-x86_64/sysroot -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -DPIC -DZLIB_CONST
CFLAGS=  -Os -fpic -march=x86-64  -std=c11 -fPIE -fomit-frame-pointer -fPIC -pthread -I/usr/include -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-char-subscripts -O3 -fno-math-errno -fno-signed-zeros -mstack-alignment=16 -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=  
ASFLAGS=  -Os -fpic -march=x86-64  -fPIC -g -Qunused-arguments
...
DLLTOOL=
WINDRES=windres
DEPWINDRES=/Users/pro/Library/Android/sdk/ndk/android-ndk-r20b/toolchains/llvm/prebuilt/darwin-x86_64/bin/x86_64-linux-android21-clang
DOXYGEN=doxygen
LDFLAGS=   --sysroot=/Users/pro/Library/Android/sdk/ndk/android-ndk-r20b/toolchains/llvm/prebuilt/darwin-x86_64/sysroot  -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=:libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample -Qunused-arguments
LDEXEFLAGS= -fPIE -pie
LDSOFLAGS=
